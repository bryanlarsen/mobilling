...
if( !class_exists( 'MO_Framework_Extender' ) )
{
    ...
    function initialize() {
        ...
        add_filter('body_class', array(&$this, 'mo_theme_skin_class'));
    ...
    function register_required_plugins() {
        ...
        $plugins = array(
            ...
            array(
                'name' => 'Brankic Photostream Widget',
    ...
    function mo_comment_form_field_comment($field) {
        $comment_field = '<p class="comment-form-comment"><label for="comment">' . _x("Comment", "mo_theme") . '</label><textarea id="comment" placeholder="' . __("Your comment", "mo_theme") . '" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>';
