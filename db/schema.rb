...
ActiveRecord::Schema.define(version: 20140722053432) do
  ...
  create_table "users", id: :uuid, default: "uuid_generate_v4()", force: true do |t|
    ...
    t.integer  "unprocessed_count",               default: 0
    t.integer  "processed_count",                 default: 0
    t.integer  "rejected_admin_attention_count",  default: 0
    t.integer  "rejected_doctor_attention_count", default: 0
