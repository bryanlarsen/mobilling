...
class ClaimTest < ActiveSupport::TestCase
  ...
  test "a saved claim should be result in saved_claim_count tally" do
    saved_claim = create(:claim, :saved)
  ...
  test "a unprocessed claim should be result in unprocessed_claim_count tally" do
    unprocessed_claim = create(:claim, :unprocessed)
  ...
  test "a processed claim should be result in processed_claim_count tally" do
    processed_claim = create(:claim, :processed)
  ...
  test "a rejected_admin_attention claim should be result in rejected_admin_attention_claim_count tally" do
    rejected_admin_attention_claim = create(:claim, :rejected_admin_attention)
  ...
  test "a rejected_doctor_attention claim should be result in rejected_doctor_attention_claim_count tally" do
    rejected_doctor_attention_claim = create(:claim, :rejected_doctor_attention)
  ...
  test "a paid claim should be result in paid_claim_count tally" do
    paid_claim = create(:claim, :paid)
