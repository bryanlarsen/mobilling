class V1::ClaimsController < V1::BaseController
  ...
  def create_claim_params
    params.require(:claim).permit(:status, :specialty, :photo_id, :patient_name, :hospital, :referring_physician, :procedure_on, :admission_on, :first_seen_on, :first_seen_consult, :last_seen_on, :most_responsible_physician, :last_seen_discharge, :icu_transfer, :consult_type, :consult_time_in, :consult_time_out, :consult_premium_visit, :consult_premium_first, :consult_premium_travel, :comment, daily_details: [:day, :code, :time_in, :time_out, :autogenerated, :fee, :units, premiums: [:code, :fee, :units]], diagnoses: [:name])
  end

  def update_claim_params
    params.require(:claim).permit(:status, :photo_id, :patient_name, :hospital, :referring_physician, :procedure_on, :admission_on, :first_seen_on, :first_seen_consult, :last_seen_on, :most_responsible_physician, :last_seen_discharge, :icu_transfer, :consult_type, :consult_time_in, :consult_time_out, :consult_premium_visit, :consult_premium_first, :consult_premium_travel, :comment, daily_details: [:day, :code, :time_in, :time_out, :autogenerated, :fee, :units, premiums: [:code, :fee, :units]], diagnoses: [:name])
  end
end
