class V1::ClaimsController < V1::BaseController
  wrap_parameters :claim, include: [:id, :patient_name, :hospital, :referring_physician, :diagnosis, :admission_on, :first_seen_on, :last_seen_on, :most_responsible_physician], format: :json
  ...
  def update_claim_params
    params.require(:claim).permit(:id, :patient_name, :hospital, :referring_physician, :diagnosis, :admission_on, :first_seen_on, :last_seen_on, :most_responsible_physician)
  end
end
