describe("details generator", function () {
    ...
    it("returns correct codes #1 (when First Date Seen = Admission Date; MRP = Yes; Consult on First Date = Yes)", function () {
        expect(detailsGenerator({
            ...
            { day: "2014-06-09", code: "A135A", premiums: [{ code: "E082A" }], autogenerated: true, time_in: null, time_out: null },
            { day: "2014-06-10", code: "C122A", premiums: [{ code: "E083A" }], autogenerated: true, time_in: null, time_out: null },
            { day: "2014-06-11", code: "C123A", premiums: [{ code: "E083A" }], autogenerated: true, time_in: null, time_out: null },
            { day: "2014-06-12", code: "C132A", premiums: [{ code: "E083A" }], autogenerated: true, time_in: null, time_out: null },
            ...
            { day: "2014-07-15", code: "C137A", premiums: [{ code: "E083A" }], autogenerated: true, time_in: null, time_out: null },
